...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.cisco.webservices.HelloWorldService {
    ...
    public org.cisco.webservices.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.cisco.webservices.HelloWorldSoapBindingStub _stub = new org.cisco.webservices.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.cisco.webservices.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.cisco.webservices.HelloWorldSoapBindingStub _stub = new org.cisco.webservices.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.cisco.org", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.cisco.org", "HelloWorld"));
        }
