...
public class HelloWorldProxy implements org.cisco.webservices.HelloWorld {
  private String _endpoint = null;
  private org.cisco.webservices.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new org.cisco.webservices.HelloWorldServiceLocator()).getHelloWorld();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public org.cisco.webservices.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
