...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="org.cisco.webservices.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        org.cisco.webservices.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
